...
emojis = np.array([
    [0x7C, 0x82, 0x129, 0x101, 0x17D, 0x139, 0x82, 0x7C],   # serio
    [0x7C, 0x82, 0x129, 0x101, 0x101, 0x139, 0x82, 0x7C],   # feliz 
    [0x7C, 0x82, 0x1FF, 0x16D, 0x101, 0x139, 0x82, 0x7C],   # anteojos
    [0x7C, 0x82, 0x129, 0x101, 0x139, 0x139, 0x82, 0x7C],   # sorprendido
    [0x7C, 0x82, 0x129, 0x101, 0x101, 0x101, 0x82, 0x7C],   # tieso
    [0x7C, 0x82, 0x129, 0x101, 0x1FF, 0x1FF, 0xFE, 0x7C],   # badido / covid (?
    [0x7C, 0x82, 0x129, 0x101, 0x138, 0x129, 0x82, 0x7C],   # triste 
    [0x7C, 0x82, 0x129, 0x101, 0x111, 0x119, 0x82, 0x7C],   # besito
])